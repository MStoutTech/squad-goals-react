        ...
        <main className="border border-inherit rounded-lg max-w-[550px] mx-auto mt-10 mb-20 lg:mt-20 text-sm p-10 flex flex-col gap-6">
          ...
          <form onSubmit={signup}>
            ...
            <input
              ...
              id="userName"
              name="userName"
              className="text-[16px] md:text-sm border border-inherit rounded-md px-3 py-2 w-full mb-6 h-[44px]"
            />
            ...
            <input
              ...
              name="email"
              className="text-[16px] md:text-sm border border-inherit rounded-md px-3 py-2 w-full h-[44px]"
            />
            ...
            <input
              ...
              id="password"
              name="password"
              className="text-[16px] md:text-sm border border-inherit rounded-md px-3 py-2 w-full h-[44px] mb-6"
            />
